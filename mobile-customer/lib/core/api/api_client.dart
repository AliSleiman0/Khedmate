...
/// is live in both stores; from that moment every legacy-customer request
...
class ApiClient {
  ...
  /// response. Returns an empty string when the error code matches but no
  /// `storeUrl` is present (caller falls back to `unifiedStoreUrl`). Null
  /// means "not a migration gate response — ignore".
