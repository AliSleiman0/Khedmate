    ...
    final initial = auth.when(
      data: (state) {
        if (state is AuthAuthenticated) {
          final name = state.customer.fullName.trim();
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            // Pending rating strip (if any) — above the ask headline.
            pendingAsync.when(
            ...
            _AskSection(s: s, onSpeak: () => context.go('/booking/description')),
            ...
            if (!isSearching) ...[
              ...
              _ReferralStrip(s: s, onTap: () => context.push('/referral')),
            ] else
...
class _ContextChips extends StatelessWidget {
  ...
  Widget build(BuildContext _) {
    void preselect(String id, String label) {
      ...
      this.context.go('/booking/description');
    }
    ...
    final chips = <_ChipSpec>[
      _ChipSpec(
        ...
        amber: true,
        iconEmoji: '🚨',
        onTap: () => this.context.go('/booking/category'),
      ),
      _ChipSpec(
              ...
              SizedBox(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (_, i) => _BookAgainCard(
                    ...
                    job: jobs[i],
                    onBookAgain: () {
                      final label = _labelForCategory(s, jobs[i].categoryId);
                      ref
