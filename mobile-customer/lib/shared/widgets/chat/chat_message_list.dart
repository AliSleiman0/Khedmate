...
class ChatMessageList extends StatelessWidget {
  /// The type of the "self" user — messages from `selfSenderType` appear
  /// right-aligned (brand blue bubbles); the other party is left-aligned.
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        // Add date separator when the day changes
