...
class ActiveJobDetailScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Directionality(
      ...
      child: PopScope(
        canPop: false, // back navigation disabled while job is active
        child: Scaffold(
...
// ---------------------------------------------------------------------------
// Job body — switches layout based on status
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Status-specific content and action button
// ---------------------------------------------------------------------------
...
class _InProgressActions extends ConsumerWidget {
  ...
  Future<void> _navigateToUploadPhotos(
    ...
    final completed = await Navigator.of(context).push<bool>(
      MaterialPageRoute(
        builder: (_) => UploadAfterPhotosScreen(jobId: jobId),
      ),
    );
    // If upload succeeded and advance was called in the screen,
    // refresh the active job state so the UI updates.
