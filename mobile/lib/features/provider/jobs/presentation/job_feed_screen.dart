...
class _JobCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final minutesAgo = DateTime.now().difference(job.postedAt).inMinutes;
    final timeLabel = minutesAgo < 1 ? s.timeNow : s.timeMinutesAgo(minutesAgo);
                  ...
                  child: ListTile(
                    ...
                    title: Text(job.categoryName,
                        style: const TextStyle(
                            fontFamily: 'Cairo',
                            fontWeight: FontWeight.bold)),
                    subtitle: Text('${job.district} · ${job.referenceNumber}',
                        style: const TextStyle(fontFamily: 'Cairo')),
                    trailing: Text(
